...
uvx /path/to/ibmdiagrams-3.3.2-py3-none-any.whl --mcp
```
...
```json
{
  "mcpServers": {
    "ibmdiagrams": {
      "command": "uvx",
      "args": [
        "/Users/username/path/to/ibmdiagrams-3.3.2-py3-none-any.whl",
        "--mcp"
      ]
    }
  }
...
```json
{
  "mcpServers": {
    ...
    "ibmdiagrams-dev": {
      "command": "uvx",
      "args": [
        "/path/to/dev/ibmdiagrams-3.3.2-py3-none-any.whl",
        "--mcp"
      ]
    }
  }
