...
class _IBMConnector(Connector):
    def __init__(self, label="", startarrow="", endarrow="", fontname="IBM Plex Sans", fontsize=14, linetype="solid", linewidth=1, linecolor="#000000"):
        super(_IBMConnector, self).__init__(label=label, 
                                            startarrow=startsrrow, endarrow=endarrow, 
