...
class _IBMConnector(Connector):
    def __init__(self, label="", startarrow="", endarrow="", font="IBM Plex Sans", linetype="solid", linewidth=1, linecolor="#000000", operator="", sourceid=None, targetid=None ):
        super(_IBMConnector, self).__init__(label=label, 
                                            startarrow=startarrow, endarrow=endarrow, 
                                            linetype=linetype, linewidth=linewidth, operator=operator, sourceid=sourceid,
                                            targetid=targetid, linecolor=linecolor)
