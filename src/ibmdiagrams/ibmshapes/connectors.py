...
class SolidEdge(_Connector):
    def __init__(self, label="", startarrow="", endarrow="", width=1, color="#000000", operator="", sourceid=None, targetid=None):
...
class LongDashedEdge(_Connector):
    def __init__(self, label="", startarrow="", endarrow="", width=1, color="#000000", operator="", sourceid=None, targetid=None):
        super(LongDashedEdge, self).__init__(label,
                                             startarrow=startarrow, endarrow=endarrow,
                                             linetype="longdashed", linewidth=width, linecolor=color,
                                             operator=operator, sourceid=sourceid, targetid=targetid)
...
class TunnelEdge(_Connector):
    def __init__(self, label="", startarrow="", endarrow="", width=1, color="#FFCCCC", operator="", sourceid=None, targetid=None):
