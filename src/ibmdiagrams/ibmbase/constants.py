...
class CombinedStyle(Enum):
    ...
    # Expanded and grouping shapes with one line label.
    EPNODE1 = (
        BaseStyle.FONT.value
        + BaseStyle.EPNODE_LABEL1.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    PLOC1 = (
        BaseStyle.FONT.value
        + BaseStyle.PLOC_LABEL1.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    GPLOC1 = (
        BaseStyle.FONT.value
        + BaseStyle.GPLOC_LABEL1.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    ZONE1 = (
        BaseStyle.FONT.value
        + BaseStyle.ZONE_LABEL1.value
        + BaseStyle.ZONE.value
        + BaseStyle.NON_CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    GZONE1 = (
        BaseStyle.FONT.value
        + BaseStyle.GZONE_LABEL1.value
        + BaseStyle.ZONE.value
        + BaseStyle.NON_CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    ...
    EPNODE2 = (
        BaseStyle.FONT.value
        + BaseStyle.EPNODE_LABEL2.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    PLOC2 = (
        BaseStyle.FONT.value
        + BaseStyle.PLOC_LABEL2.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    GPLOC2 = (
        BaseStyle.FONT.value
        + BaseStyle.GPLOC_LABEL2.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    ZONE2 = (
        BaseStyle.FONT.value
        + BaseStyle.ZONE_LABEL2.value
        + BaseStyle.ZONE.value
        + BaseStyle.NON_CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    ...
    EPNODE3 = (
        BaseStyle.FONT.value
        + BaseStyle.EPNODE_LABEL3.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    PLOC3 = (
        BaseStyle.FONT.value
        + BaseStyle.PLOC_LABEL3.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    GPLOC3 = (
        BaseStyle.FONT.value
        + BaseStyle.GPLOC_LABEL3.value
        + BaseStyle.CONTAINER.value
        + BaseStyle.IMAGE.value
    )
    ZONE3 = (
        BaseStyle.FONT.value
        + BaseStyle.ZONE_LABEL3.value
        + BaseStyle.ZONE.value
        + BaseStyle.NON_CONTAINER.value
        + BaseStyle.IMAGE.value
    )
...
class ShapePos(Enum):
    ...
    PUBLIC_NETWORK_HEIGHT = (
        TOP_SPACE + (ICON_SPACE * PUBLIC_ICON_COUNT) + (ICON_HEIGHT * PUBLIC_ICON_COUNT)
    )

    ENTERPRISE_ICON_COUNT = 1
    ENTERPRISE_NETWORK_WIDTH = ICON_SPACE * 3
    ENTERPRISE_NETWORK_HEIGHT = (
        TOP_SPACE + (ICON_SPACE * ENTERPRISE_ICON_COUNT) + (ICON_HEIGHT * ENTERPRISE_ICON_COUNT)
    )
