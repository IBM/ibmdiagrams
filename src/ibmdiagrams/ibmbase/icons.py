...
class Icons:
   iconDictionary = {
      ...
      'Enterprise Network': {'icon': 'network--enterprise', 'color': Colors.lines["network"], 'fill': Colors.fills["white"], 'staticicon': 'Undefined Group', 'catalogicon': '**Undefined Group'},
      ...
      'Power Workspace': {'icon': 'ibm--power-vs', 'color': Colors.lines["network"], 'fill': Colors.fills["white"], 'staticicon': 'Undefined Group', 'catalogicon': 'Workspace for Power Virtual Server'},
      ...
      'Z Containers': {'icon': 'ibm-z-os--containers', 'color': Colors.lines["compute"], 'fill': Colors.fills["white"], 'staticicon': 'Undefined Group', 'catalogicon': 'Undefined Group'},
      'watsonx': {'icon': 'watsonx', 'color': Colors.lines["compute"], 'fill': Colors.fills["white"], 'staticicon': 'Watsonx', 'catalogicon': 'watsonx'},
      ...
      'Expanded Power Virtual Server': {'icon': 'ibm--power-vs', 'color': Colors.lines["compute"], 'fill': Colors.fills["compute"], 'staticicon': 'Undefined Node', 'catalogicon': 'Power Virtual Server Virtual Machine'},
      ...
      'Expanded Application': {'icon': 'application', 'color': Colors.lines["compute"], 'fill': Colors.fills["applications"], 'staticicon': 'Application', 'catalogicon': 'Undefined Node'},
      'Expanded Microservice': {'icon': 'microservices--1', 'color': Colors.lines["compute"], 'fill': Colors.fills["compute"], 'staticicon': 'Undefined Node', 'catalogicon': 'Undefined Node'},
      ...
      'Microservice': {'icon': 'microservices--1', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Actor', 'catalogicon': '*Undefined Actor'},
      ...
      'watsonx Orchestrate': {'icon': 'ibm-watsonx--orchestrate', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Undefined Node'},
      'watsonx Assistant': {'icon': 'ibm-watsonx--assistant', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'watsonx Assistant'},
      'watsonx Code Assistant': {'icon': 'ibm-watsonx--code-assistant', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'watsonx Code Assistant'},
      'watsonx Z Code Assistant': {'icon': 'ibm-watsonx--code-assistant-for-z', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Undefined Node'},
      'watsonx Z Refactor Code Assistant': {'icon': 'ibm-watsonx--code-assistant-for-z--refactor', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Undefined Node'},
      'Watson Discovery': {'icon': 'ibm-watson--discovery', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Watson Discovery'},
      'Watson Machine Learning': {'icon': 'ibm-watson--machine-learning', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Watson Machine Learning'},
      'Watson Studio': {'icon': 'ibm-watson--studio', 'color': Colors.lines["applications"], 'fill': Colors.lines["applications"], 'staticicon': 'Undefined Node', 'catalogicon': 'Watson Studio'},
      ...
      'Power Virtual Server': {'icon': 'ibm--power-vs', 'color': Colors.lines["compute"], 'fill': Colors.lines["compute"], 'staticicon': 'Undefined Node', 'catalogicon': 'Power Virtual Server Virtual Machine'},
      ...
      'Ansible': {'icon': 'logo--ansible-community', 'color': Colors.lines["devops"], 'fill': Colors.lines["devops"], 'staticicon': 'Undefined Node', 'catalogicon': 'Undefined Node'},
      ...
      'Floating IP': {'icon': 'floating-ip', 'color': Colors.lines["network"], 'fill': Colors.lines["network"], 'staticicon': 'Floating IP', 'catalogicon': 'Undefined Node'},
      ...
      'Bastion Host': {'icon': 'bastion-host', 'color': Colors.lines["security"], 'fill': Colors.lines["security"], 'staticicon': 'Bastion Host', 'catalogicon': 'Undefined Node'},
