...
class Types:
    ...
    def buildLink(
        ...
        if linetype.upper() == "DOUBLE":
            ...
            style += (
                "shape=flexArrow;startArrow=none;endArrow=none;strokeColor=none;fillColor="
                + linecolor
                + ";"
            )
        else:
            ...
            if startarrow == "":
                ...
                style += (
                    "startArrow=" + startarrow + ";startFill=" + ("1" if startfill else "0") + ";"
                )
                if startarrow == "oval":
    ...
    def buildStaticGroupSidebar(self, parentid, node):
        ...
        cell = {"id": randomid(), "value": "", "style": style, "vertex": "1", "parent": parentid}

        geo = {"x": str(0), "y": str(0), "width": str(4), "height": str(48), "as": "geometry"}
    ...
    def buildStaticGroupIcon(self, parentid, node):
        ...
        geo = {"x": str(12), "y": str(12), "width": str(24), "height": str(24), "as": "geometry"}
    ...
    def buildStaticExpandedIcon(self, parentid, node):
        ...
        geo = {"x": str(0), "y": str(0), "width": str(48), "height": str(48), "as": "geometry"}
    ...
    def buildStaticShape(self, id, node, x, y, width, height, meta, genflag, items):
        ...
        if shape != "actor" and shape != "pnode":
            ...
            styleFill = "fillColor=" + fillcolor + ";" if fillcolor else "fillColor=none;"
        ...
        cell = {"id": id, "value": shapelabel, "style": style, "vertex": "1", "parent": parentid}
    ...
    def buildActorShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        geo = {"x": str(x), "y": str(y), "width": str(48), "height": str(48), "as": "geometry"}
        ...
        if custom_icon:
            ...
            styleicon = (
                "shape=mxgraph.ibm_cloud."
                + (icon if icon else "undefined")
                + ";fillColor=#ffffff;strokeColor=none;dashed=0;outlineConnect=0;part=1;movable=0;resizable=0;rotatable=0;"
            )
        ...
        cell = {"id": id + "-icon", "value": "", "style": styleicon, "vertex": "1", "parent": id}
        ...
        point = {"x": str(12), "y": str(12), "as": "offset"}
    ...
    def buildPNodeShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        point = {"x": str(offset), "y": str(offset), "as": "offset"}
    ...
    def buildEPNodeShape(self, id, node, x, y, width, height, meta, shapelabel, linecount=1):
        ...
        styleshape = (
            "container=1;collapsible=0;expand=0;recursiveResize=0;image=;strokeColor="
            + linecolor
            + ";fillColor="
            + fillcolor
            + ";"
        ...
        cell = {"id": id, "value": "", "style": styleshape, "vertex": "1", "parent": parentid}
    ...
    def buildPLocShape(self, id, node, x, y, width, height, meta, shapelabel, linecount):
        ...
        iconcolor = node.get(
            "iconcolor", linecolor
        )  # Use iconcolor if available, fallback to linecolor
        styleshape = (
            "container=1;collapsible=0;expand=0;recursiveResize=0;image=;strokeColor="
            + linecolor
            + ";fillColor="
        ...
        custom_icon = node.get("custom_icon")
        if custom_icon:
            resource_name = node.get("label", "")  # noqa: F841
            resource_class = node.get("classname", self.__class__.__name__)  # noqa: F841
            logger.info(
                "Using custom_icon for %s%s",
                resource_class,
                f": {resource_name}" if resource_name else "",
        ...
        stylesidebar = (
            "shape=rect;strokeColor=none;fillColor="
            + linecolor
            + ";aspect=fixed;resizable=0;part=1;spacingLeft=5;"
        )
        ...
        geo = {"width": str(4), "height": str(48), "relative": str(1), "as": "geometry"}
    ...
    def buildZoneShape(self, id, node, x, y, width, height, meta, shapelabel, linecount):
        ...
        header = {"id": id + "-icon", "label": shapelabel, "placeholders": "1"}  # noqa: F841
    ...
    def buildPage(self, name):
        data = {
            "header": {"id": self.common.compress(name), "name": name},
            "graph": {
                "dx": "1434",
                "dy": "822",
                "grid": "1",
