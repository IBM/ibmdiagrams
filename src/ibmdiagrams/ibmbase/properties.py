...
class Properties:
    ...
    def printConnector(self, shapeid):
        logger.debug("printConnector:")
        logger.debug("connectorid:")
        logger.debug(shapeid)
        logger.debug("label:")
    ...
    def getDiagramsProperties(self, attrtype="diagrams", name="", filename=""):
        return {"type": attrtype, "name": name, "filename": filename}

    def getDiagramProperties(
        self,
        attrtype="diagram",
        name="",
        filename="",
    ...
    def getSingleArrowProperties(
        self, label="", sourceid="", targetid="", linecolor="", fontname="", fontsize=0
    ):
